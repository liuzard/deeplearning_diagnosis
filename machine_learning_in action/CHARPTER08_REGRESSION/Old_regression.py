...
data_mat, label_mat = loadDataSet('C:\\Users\liuzard\PycharmProjects\deep_learning\machine_learning_in action\CHARPTER08_REGRESSION\ex0.txt')
print(label_mat)
...
ws = standRegres(data_mat,label_mat)
print(ws)
