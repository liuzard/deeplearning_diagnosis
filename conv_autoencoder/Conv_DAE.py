...
mnist = input_data.read_data_sets('C:\\Users\liuzard\PycharmProjects\deep_learning\MNIST_data', validation_size=0, one_hot=False)
...
loss = 0.5*tf.squared_difference(logits_,targets_)
